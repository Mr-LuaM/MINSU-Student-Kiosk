<x-app-layout>
    <div class="container mx-auto px-6 py-6">
        ...
        <div class="flex justify-between items-center mb-4 border-b border-gray-300 pb-3">
            ...
            <div class="flex items-center space-x-5">
                ...
                <a href="{{ route('admin.students.edit', $student->student_id) }}"
                    class="text-green-600 hover:text-green-800 transition font-medium text-sm">
                    ✏️ Edit
                </a>
        ...
        <!-- Student Information -->
        <div class="bg-card shadow-md rounded-lg p-5 mb-5">
            <h2 class="text-lg font-semibold text-primary border-b pb-2 mb-4">Personal Information</h2>
        ...
        <!-- Academic Details -->
        <div class="bg-card shadow-md rounded-lg p-5 mb-5">
            <h2 class="text-lg font-semibold text-primary border-b pb-2 mb-4">Academic Details</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-800">
        ...
        <!-- Contact Details -->
        <div class="bg-card shadow-md rounded-lg p-5 mb-5">
            <h2 class="text-lg font-semibold text-primary border-b pb-2 mb-4">Contact Information</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-800">
        ...
        <!-- Skills -->
        <div class="bg-card shadow-md rounded-lg p-5 mb-5">
            <h2 class="text-lg font-semibold text-primary border-b pb-2 mb-4">Skills</h2>
            @if($student->skills->isEmpty())
            <p class="text-gray-600">No skills recorded.</p>
            @else
            <ul class="list-disc pl-5 mt-2 text-gray-900 text-sm">
        ...
        <!-- Achievements -->
        <div class="bg-card shadow-md rounded-lg p-5">
            <h2 class="text-lg font-semibold text-primary border-b pb-2 mb-4">Achievements</h2>
